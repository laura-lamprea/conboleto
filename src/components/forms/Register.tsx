	...
	return (
		<div className="w-[310px] sm:w-[352px] mx-auto pr-0 sm:pr-6 2xl:pr-0">
			<form onSubmit={handleSubmit(onSubmit)}>
				<div className="flex space-x-2 pb-1 ">
					<div className="">
						...
						<input
							...
							type="text"
							{...register("name")}
							className="h-[54px] w-full px-3.5 py-4 text-xs 2xl:text-sm text-gray-800 rounded-lg border border-gray-400 border-opacity-20"
						/>
				...
				<div className="w-full h-[22px] my-4 text-center text-gray-800 text-xs 2xl:text-sm font-normal font-['Public Sans'] leading-snug tracking-tight">
