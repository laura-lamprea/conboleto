...
const Card = ({event}: any) => {
	return (
		<div className="w-[355px] rounded-xl bg-white shadow border border-neutral-200">
			...
			<div className="flex flex-col justify-between px-[22px] pt-[15px] pb-4 h-[172px]">
				<div>
					<p className="text-zinc-800 text-[22px] font-semibold tracking-tight">
						{event.name}
					</p>
					<p className="w-[159px] h-[25px] text-zinc-600 text-base font-medium">
						Guadalajara, Jalisco
					</p>
					<p className="w-[159px] h-[25px] text-zinc-600 text-base font-medium">
						Auditorio Telmex
